...
(function () {
  ...
  // NOTE: 'Sesiones' is intentionally hidden from the menu while the strategy
  // is focused on the Program. The page (sesiones.html) is kept untouched and
  // can be re-activated by re-adding its entry below.
  const links = [
    ...
    navMount.outerHTML = `
      <header class="nav" id="nav">
        <div class="nav__inner">
          <a class="nav__logo" href="index.html" aria-label="Cristian Casamitjana · Transformación Personal">
          ...
          <a class="btn btn--primary nav__cta" href="contacto.html">Empezar el programa</a>
        </div>
      </header>`;
  }
        ...
        <div class="footer__inner">
          <div class="footer__top">
            <div class="footer__brand">
              <img src="assets/logo-white.png" alt="Cristian Casamitjana · Transformación Personal" />
              <p>Psicología integrativa enfocada en transformación personal. Trabajo emocional, mental y transgeneracional para dejar de repetir patrones y volver a ti.</p>
            ...
            <div>
              ...
              <ul>
                ...
                <li><a href="programa.html">Programa de 7 semanas</a></li>
                <li><a href="contacto.html?from=descubrir">Sesión de reconocimiento gratis</a></li>
              </ul>
            </div>
          </div>
          <div class="footer__bottom">
            <div>© ${new Date().getFullYear()} Cristian Casamitjana · Transformación Personal</div>
